    ...
    <page-section>
      ...
      <div class="grid grid-cols-8 gap-6 lg:gap-x-12 lg:gap-y-10 mt-8 -mb-16 lg:-mb-10">
        ...
        <div class="col-span-8 lg:col-span-4 lg:col-start-5">
          <h2 class="font-extrabold text-lg pb-1">The freedom to try new things</h2>
        ...
        <div class="col-span-8 lg:col-span-4">
          <h2 class="font-extrabold text-lg pb-1">Work/life balance</h2>
        ...
        <div class="col-span-8 lg:col-span-4 lg:col-start-5">
          <h2 class="font-extrabold text-lg pb-1">Pride and openness in what we do</h2>
    ...
    <page-section>
      <div class="grid grid-cols-12 bg-logiclylightgrey mb-10">
        ...
        <div class="col-span-10 col-start-2 mt-4 lg:mt-8">
          <h1 class="mb-4 font-extrabold text-xl text-logiclyorange">Join our team</h1>
        </div>
