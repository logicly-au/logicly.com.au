<template>
  <div>
    ...
    <page-section>
      <div class="grid grid-cols-12 gap-6 mx-0 lg:gap-8 text-logiclytextgrey md:mx-0 lg:mx-0">
        <div class="col-span-12">
          <h2 class="pb-2 text-2xl font-semibold text-center lg:pb-6">Scope of work and services</h2>
        </div>
