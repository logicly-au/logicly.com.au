  ...
  <div>
    ...
    <page-section>
      <div class="text-logiclytextgrey">
        <h2 class="mb-10 text-2xl font-semibold text-center xl:mb-16">We work with clients across different industries to understand their internal and external stakeholders so that the systems we build really do meet their needs</h2>
        <vsa-list>
