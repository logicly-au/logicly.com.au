      ...
      <div class="container mx-auto">
        <div class="grid h-64 grid-rows-3 grid-cols-15">
          <div class="row-start-2 text-center text-white col-span-15">
            <div>
              <h1 class="text-lg font-bold">WHO WE HELP</h1>
              <h2 class="text-xl font-bold">Our clients approach us with a range of challenges</h2>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container py-8 mx-auto">
        ...
        <div class="grid grid-cols-15">
          ...
          <div class="col-span-7 col-start-5">
            <p>We help clients understand the power of technology to improve efficiencies and gain quality information
      ...
      <div class="container mx-auto my-4">
        ...
        <div class="grid grid-cols-15">
          ...
          <div class="grid grid-cols-2 col-span-11 col-start-3 mt-4">
            ...
            <div class="col-span-11 col-start-3">
              <h2>Meeting the internal and external needs of different industries</h2>
              <vsa-list>
            ...
            <div class="col-span-11 col-start-3">
              <img src="~/assets/images/What-are-your-information-and-digital-needs.jpg" />
              <!-- TODO Replace placeholder image here -->
              <div class="relative font-bold text-center text-white top-center">What are your information and digital
                needs?</div>
            </div>
