<template>
    <div>
      ...
      <page-section>
        ...
        <div class="grid grid-cols-8 gap-6 mt-8 -mb-16 lg:gap-x-12 lg:gap-y-10 text-logiclytextgrey lg:-mb-10">
          <div class="col-span-8 lg:col-span-4">
            <h2 class="pb-1 text-lg font-bold">A family environment</h2>
          ...
          <div class="col-span-8 lg:col-span-4 lg:col-start-5">
            <h2 class="pb-1 text-lg font-bold">The freedom to try new things</h2>
          ...
          <div class="col-span-8 lg:col-span-4">
            <h2 class="pb-1 text-lg font-bold">Work/life balance</h2>
          ...
          <div class="col-span-8 lg:col-span-4 lg:col-start-5">
            <h2 class="pb-1 text-lg font-bold">Pride and openness in what we do</h2>
      ...
      <page-section>
        <div class="grid grid-cols-12 bg-logiclylightgrey">
          ...
          <div class="col-span-10 col-start-2 mb-4 lg:col-span-5 lg:col-start-2">
            <h2 class="pr-0 text-xl font-semibold leading-snug text-logiclytextgrey lg:pr-8">Are you excited about learning, sharing knowledge and solving information problems?</h2>
          </div>
      ...
      <page-section>
        <img src="Our_mission.svg" class="content-center h-24"/>
          ...
          <div class="flex justify-center ">
            <div class="justify-center mb-6">
              <h1 class="text-2xl font-semibold leading-snug text-center pb-2 pt-4 xl:pt-8">Our mission</h1>
              <h2 class="font-light text-lg text-center">We thoughtfully design digital systems that solve our clients’ complex information problems.</h2>
            </div>
          </div>
          ...
          <div class="grid grid-cols-12 px-0 pb-0 mb-0 text-logiclytextgrey">
            ...
            <div class="col-span-11 xl:col-span-6 pl-4 xl:-ml-12 pb-4 sm:pb-8 xl:pb-16">
              <h3 class="pb-3 font-medium xl:pt-0">
        ...
        <div class="flex justify-center ">
            <div class="justify-center mb-6">
              <h2 class="font-light text-lg text-center">Logicly is constituted by its shareholders, directors, employees, clients, suppliers, partners and the local community. Logicly is committed to contributing to positive environmental and social impact outcomes.</h2>
            </div>
          </div>
      </page-section>
